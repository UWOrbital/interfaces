...
// CMD_DOWNLINK_IMAGE
static void unpackDownlinkImageCmdData(const uint8_t* buffer, uint32_t* offset, cmd_msg_t* msg);
...
static const unpack_func_t unpackFns[] = {
    ...
    [CMD_DOWNLINK_IMAGE] = unpackDownlinkImageCmdData,
...
// CMD_DOWNLINK_IMAGE
static void unpackDownlinkImageCmdData(const uint8_t* buffer, uint32_t* offset, cmd_msg_t* cmdMsg) {
  // No data to unpack
}
