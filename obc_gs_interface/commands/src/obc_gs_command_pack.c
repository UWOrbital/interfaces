...
static void packCC1120RegisterReadCmdData(uint8_t* buffer, uint32_t* offset, const cmd_msg_t* msg);
...
// CMD_CC1120_REGISTER_READ
static void packCC1120RegisterReadCmdData(uint8_t* buffer, uint32_t* offset, const cmd_msg_t* cmdMsg) {
  // No data to pack
}
